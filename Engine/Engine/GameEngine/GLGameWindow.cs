...
namespace Engine.GameEngine
{
    public class GLGameWindow : OpenTK.GameWindow
    {
        ...
        public GLGameWindow(int width = 640, int height = 480, string title = "My Game", double updateRate = (1.0 / 30), WindowBorder windowBorder = WindowBorder.Fixed, GameWindowFlags windowFlags = GameWindowFlags.Default) 
